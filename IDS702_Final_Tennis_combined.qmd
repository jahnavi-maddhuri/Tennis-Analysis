...
```{r}
# Maybe we don't include this plot bc number of wins/losses are the same for all surface types.
library(ggplot2)

# Create the stacked bar chart
ggplot(tennis_long_clean, aes(x = surface, fill = win)) +
  geom_bar(position = "stack") +
  scale_fill_manual(values = c("Win" = "blue", "Loss" = "red")) +
  labs(
    title = "Wins vs Losses by Surface Type",
    x = "Surface Type",
    y = "Number of Matches",
    fill = "Match Outcome"
  ) +
