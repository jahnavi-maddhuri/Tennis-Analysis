...
Rank difference (the disparity in player rankings) alone has a significant but small effect on match duration at the baseline level. Each unit increase in rank difference decreases match duration by approximately 0.2%. This suggests that larger rank disparities generally lead to shorter matches, as stronger players dominate weaker opponents more quickly.
