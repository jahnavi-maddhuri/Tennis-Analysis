...
Lastly, for highly correlated information, a VIF technique was used ratios have been computed to continue to capture granularity in information, but also reduce the number of variables needed in any model, minimizing multicollinearity.
